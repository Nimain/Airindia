    ...
    <div style={{ minHeight: '100vh', background: '#F5F7FA', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{
        ...
        <div style={{
          ...
          boxShadow: '0 8px 32px rgba(26,43,109,0.12)'
        }}>
          🛡️
        </div>
        ...
        <p style={{
          ...
          We&apos;re building a comprehensive safety standards portal aligned with DGCA and ICAO regulations.
          Check back soon for detailed compliance frameworks and training guidelines.
        </p>
        ...
        <div style={{ display: 'flex', gap: '48px', marginBottom: '48px' }}>
          {[
            { value: 'DGCA', label: 'Certified Programs' },
            { value: 'ICAO', label: 'Compliant Training' },
            { value: 'IS-BAO', label: 'Safety Standards' },
          ].map((s, i) => (
            <div key={i} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '22px', fontWeight: 900, color: '#1A2B6D' }}>{s.value}</div>
